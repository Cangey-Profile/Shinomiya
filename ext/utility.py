...
def apply_vars(bot: 'lyss', tag: str, message: discord.Message, user_input: str) -> str:
...
class Detection:
    ...
    async def check_constraints(self, bot: lyss, message: discord.Message) -> bool:
    ...
    async def punish(self, bot: lyss, message: discord.Message, *, reason=None, purge_limit=None):
